...
## 8. 待决问题与裁决结果（2026-09-13 已全部拍板）

| # | 问题 | 我的建议 |
|---|------|----------|
| Q-4A-1 | ~~`UserMenu`（全站 NavBar）是否并入本批？~~ | ✅ **用户裁决（2026-09-13）：并入**（同类缺陷、一行改动） |
| Q-4A-2 | ~~T4 换掉 daisyUI 三点属"行为变更"，是否接受？~~ | ✅ **用户裁决（2026-09-13）：接受**（现状在 reduce 下永动是硬缺陷） |
